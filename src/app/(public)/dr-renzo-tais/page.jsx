...
const tratamientos = [
  ...
  "Volnewmer",
  "Láser CO₂",
  "Blefaroplastia no quirúrgica con Láser CO₂",
  "Armonización facial no invasiva",
  "Armonización genital masculina y femenina no invasiva",
  ...
  return (
    <main className="bg-[#f6f7fb] text-slate-900">
      <section className="mx-auto grid w-full max-w-7xl gap-12 px-6 pb-20 pt-24 md:px-10 md:pb-24 md:pt-28 lg:grid-cols-[1fr_1.15fr] lg:items-center xl:px-12 xl:gap-16">
        ...
        <div>
          ...
          <h1 className="mt-5 text-4xl text-left leading-tight sm:text-5xl">
            Médico Cirujano con enfoque regenerativo y no invasivo.
          </h1>
          ...
          <div className="mt-7 space-y-5 text-sm leading-relaxed text-slate-600 sm:text-base">
            ...
            <p>
              Mi enfoque combina evaluación médica rigurosa, medicina estética regenerativa
              y técnicas no invasivas para lograr resultados naturales y armónicos.
            </p>
            <p>
      ...
      <section className="mx-auto w-full max-w-7xl px-6 pb-28 md:px-10 md:pb-32 xl:px-12"> 
            ...
            Actualmente, incorporo protocolos avanzados como Volnewmer, Láser de CO2 y Blefaroplastia no quirúrgica con Láser de CO2 para tratamientos faciales y corporales personalizados.
            Me fui capacitando de manera continua con KOL en áreas especificas con el Dr Fernando Silik, el dermatólogo Dr Daniel Muszalski, Dr Sergio Escobar ( fundador del BAAS ), Dra Veronica Muchnik ( reconocida por su manejo en cánulas en tratamientos faciales) entre otros.
