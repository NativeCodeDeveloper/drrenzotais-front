            ...
            <nav className="p-3 space-y-2">
              ...
              <div className="border-t border-white/[0.06] pt-2">
                ...
                <button
                  ...
                  className="group/link flex items-center gap-2.5 rounded-md px-3 py-2.5 text-[13px] font-medium text-red-400/70 hover:text-red-400 hover:bg-white/[0.05] transition-all duration-150 w-full"
                >
                  <svg className="h-3.5 w-3.5 text-red-400/40 group-hover/link:text-red-400 transition-colors duration-150" viewBox="0 0 20 20" fill="currentColor">
